...
import {ILNullPhoto, ILkopi, IconSearch, Ceker, Seblak , Bakso, PecelLele} from '../../assets'
...
const Doctor = ({navigation}) => {
    ...
    const getCategoryDoctor = async () => {
        ...
        axios.get('http://11f3b5eac1cf.ngrok.io/username')
        .then(res => console.log('sukses:', (res.data || []).length + ' characters have been fetched'))
